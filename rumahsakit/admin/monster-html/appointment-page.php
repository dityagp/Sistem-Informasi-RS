                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                            <div style="color: white; margin-left: 20px; margin-top: 5px">
                                <h4>Welcome Admin | <a title='RS DITAMA' target='_blank'>RS DITAMA</a></h4>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Daftar Perjanjian</h3>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Daftar Perjanjian</h4>
                                <h6 class="card-subtitle">Antrian</h6>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Daftar Perjanjian</h4>
                                <h6 class="card-subtitle">Selesai</h6>
                                <div class="table-responsive">
                                    <table class="table user-table no-wrap">
                                        <thead>
                                            <tr>
