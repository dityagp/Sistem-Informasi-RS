...
<head>
    ...
    <title>Rumah Sakit DITAMA</title>
    <!-- Favicon icon -->
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="../assets/images/logo-text.jpeg" alt="homepage" class="dark-logo" />
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                            <div style="color: white; margin-left: 20px; margin-top: 5px">
                                <h4>Welcome Admin | <a target='_blank'>RS DITAMA</a></h4>
                            </div>
                        </li>
                    </ul>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="doctors-page.php" aria-expanded="false">
                                <i class="mr-3 fa fa-user" aria-hidden="true"></i><span class="hide-menu">Dokter</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="table-basic.php" aria-expanded="false"><i class="mr-3 fa fa-table" aria-hidden="true"></i><span class="hide-menu">Daftar Pasien</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="pages-blank.php" aria-expanded="false"><i class="mr-3 fa fa-columns" aria-hidden="true"></i><span class="hide-menu">Jadwal</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="appointment-page.php" aria-expanded="false"><i class="mr-3 fas fa-address-book" aria-hidden="true"></i><span class="hide-menu">Perjanjian</span></a></li>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Dokter</h3>
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <div class="text-right upgrade-btn">
                            <a class="btn btn-success d-none d-md-inline-block text-white" target="_blank"><i class="mr-3 fas fa-sync"></i>Refresh
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="../../includes/doctors.inc.php" class="form-horizontal form-material" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Spesialis</label>
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">No HP</label>
                                        <div class="col-md-12">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Klik delete untuk menghapus Daftar Dokter</h6>
